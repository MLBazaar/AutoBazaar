...
class MLBlock():
    ...
    @log_times('primitive_times', append=True)
    def _build_instance(self, **kwargs):
    ...
    def set_hyperparameters(self, hyperparameters):
        ...
        if self._class:
            ...
            self.instance = self._build_instance(**self.get_hyperparameters())
    ...
    @log_times('primitive_times', append=True)
    def _fit_instance(self, **fit_kwargs):
    ...
    def fit(self, **kwargs):
        ...
        if self.fit_method is not None:
            ...
            self._fit_instance(**fit_kwargs)

    @log_times('primitive_times', append=True)
    def _produce_instance(self, **produce_kwargs):
        return getattr(self.instance, self.produce_method)(**produce_kwargs)

    @log_times('primitive_times', append=True)
    def _produce_primitive(self, **produce_kwargs):
